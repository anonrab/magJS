...
var _historyUpdateTimeout,
	...
	_updateHash = function() {
		...
		var isPortrait = checkScreenRotation();
		if(hash.isPortrait) {
			isPortrait = hash.isPortrait;
		}

		var newHash = _initialHash + '&'  +  'gid=' + _options.galleryUID + '&' + 'pid=' + (_currentItemIndex + 1) + '&isPortrait=' + isPortrait;
